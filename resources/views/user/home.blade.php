            ...
            <div class="body">
              ...
              <div class="site-info">
                <div class="avatar mr-2">
                  ...
                  <span>Rogerio Adamo</span>
                </div>
                <span class="mai-time"></span> 1 semanana
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-blog">
            ...
            <div class="body">
              ...
              <div class="site-info">
                ...
                <span class="mai-time"></span> 4 semanas
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <form class="main-form">
        <div class="row mt-5 ">
          ...
          <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
            <textarea name="message" id="message" class="form-control" rows="6" placeholder="Por favor escreva uma mensagem..."></textarea>
          </div>
        </div>
